...
const plans = [
  {
    ...
    description:
      'Designed for ultra-low-end customers looking to get started online.',
    features: [
  ...
  },
  {
    ...
    description:
      'Perfect for small businesses or startups looking to establish an online presence.',
    features: [
  ...
  },
  {
    ...
    description:
      'Ideal for growing businesses that need advanced features and professionalism.',
    features: [
  ...
  },
  {
    ...
    description:
      'Best suited for enterprises with complex needs and focus on scalability.',
    features: [
      ...
      <div className="container mx-auto px-6">
          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative flex flex-col p-8 rounded-2xl border ${
                plan.highlight
                  ? 'border-brand-red shadow-2xl scale-105 z-10 bg-white dark:bg-zinc-900'
            ...
            >
              ...
              <div className="mb-6">
                <h3 className="text-lg font-bold font-heading text-primary dark:text-white mb-2">
                  {plan.name}
                </h3>
              ...
              <Link
                href={`/start-project?plan=${encodeURIComponent(
                  plan.name
                )}&price=${encodeURIComponent(plan.priceRange[currency])}`}
                className="mt-auto"
              >
                <Button
                  variant={plan.highlight ? 'primary' : 'outline'}
                  className="w-full bg-primary text-white font-semibold text-xs cursor-pointer"
                >
                  Choose Plan
                </Button>
              </Link>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-8">
            For businesses with unique needs or large-scale projects, we offer
            fully customizable solutions starting at{' '}
            <span className="font-bold">
              {currency === 'INR' ? '₹10,00,000' : '$12,000'}
            </span>
            .
          </p>
          <Link href="/contact">
